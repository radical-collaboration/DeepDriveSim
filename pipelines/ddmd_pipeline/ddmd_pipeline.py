...
class DDMdWorkflow(DDSimManager):
    ...
    Extends DDSimManager to implement the full DeepDriveMD pipeline
    ...
    def _generate_task_descriptions(self):
        """Build resource-requirement dicts for each pipeline stage.
    ...
    def _init_experiment_dir(self) -> None:
        """Create the experiment directory tree for all pipeline stages."""
    ...
    def stop_simulation(self, *args, **kwargs):
        ...
        This pipeline designed to replicate original ENTK pipeline
        """
        return False
    ...
    def register_tasks(self):
        """Register all pipeline stages as asyncflow executable tasks.
