...
from workflows.ddmd_workflow.agents.lof.config import OutlierDetectionConfig
from workflows.ddmd_workflow.data.api import DeepDriveMD_API
from workflows.ddmd_workflow.data.utils import get_virtual_h5_file, parse_h5
...
def get_representation(
    ...
    if model_type == "AAE3d":
        from workflows.ddmd_workflow.models.aae.inference import generate_embeddings
        ...
        from workflows.ddmd_workflow.models.keras_cvae.inference import (
